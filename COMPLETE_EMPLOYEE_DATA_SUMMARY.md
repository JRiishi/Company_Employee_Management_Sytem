...
- Tasks: 2 records
- Leaves: 2 records
- Total Days Off: ~2-3 days

Organization Total (10 employees):
- Tasks: 20 records
- Leaves: 20 records
- Average Days Off: ~2-3 per employee
```
...
- Tasks: 4 records
- Leaves: 6 records
- Total Days Off: ~15-23 days
- Leave Types: Mix of all 4 types

Organization Total (10 employees):
- Tasks: 40 records
- Leaves: 60 records
- Average Days Off: ~15-23 per employee
```
...
- Tasks: 6 records
- Leaves: 12+ records
- Total Days Off: ~40-80 days
- Leave Types: All types represented

Organization Total (10 employees):
- Tasks: 60 records
- Leaves: 120+ records
- Average Days Off: ~40-80 per employee
```
...
- ✅ Different roles have different task types
...
- ✅ Scalable for additional employees
- ✅ Deterministic (same employee always gets same data)
...
GET /api/leaves/employee/{emp_id}?filter=month
```
...
- **Features:**
  ...
  - See leave breakdown by type
  - View total days used
  - Color-coded leave type legend
...
4. View all employee leave data
