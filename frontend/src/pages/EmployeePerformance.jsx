...
const SkeletonStats = () => (
  <Card className="p-5 flex flex-col justify-between min-h-[110px] border-white/[0.06]">
    ...
    <div className="flex items-baseline gap-2 mt-auto">
      <div className="h-8 bg-[#20202F]/50 rounded-lg w-16 animate-pulse" />
      <div className="h-4 bg-[#1A1A26] rounded-md w-12 animate-pulse" />
    </div>
  </Card>
);
    ...
    >
      ...
      <section className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 text-left w-full border-b border-white/[0.06] pb-5">
        <div>
          ...
          <p className="text-[14px] text-text-primary mt-1">Review your historical performance trends and AI-driven recommendations.</p>
        </div>
      </section>
      ...
      <section className="w-full">
        {loading ? (
          <Card className="w-full p-6 border-white/[0.06] flex flex-col sm:flex-row items-start gap-4">
            <div className="w-10 h-10 rounded-xl bg-[#1A1A26] animate-pulse shrink-0" />
            <div className="flex-1 w-full">
              <div className="h-4 bg-[#20202F]/50 rounded w-48 mb-3 animate-pulse" />
              <div className="h-4 bg-[#1A1A26] rounded w-full max-w-2xl animate-pulse" />
            </div>
          </Card>
        ) : !error ? (
          <InsightBox 
      ...
      <section className="grid grid-cols-1 gap-8 w-full">
        <Card className="p-6 w-full">
          <h3 className="text-[15px] font-semibold text-text-primary tracking-tight mb-4">Core Strengths</h3>
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 mt-1.5 rounded-full bg-emerald-500 shrink-0" />
              <div className="flex-1">
                <p className="text-[14px] font-semibold text-text-primary">Code Quality & Testing</p>
                <p className="text-[13px] text-text-primary mt-0.5">Consistently maintains 95%+ coverage on critical services.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 mt-1.5 rounded-full bg-emerald-500 shrink-0" />
              <div className="flex-1">
                <p className="text-[14px] font-semibold text-text-primary">System Architecture</p>
                <p className="text-[13px] text-text-primary mt-0.5">Highly effective at organizing complex monoliths into decoupled modules.</p>
              </div>
            </li>
          </ul>
        </Card>
        ...
        <Card className="p-6 w-full">
          <h3 className="text-[15px] font-semibold text-text-primary tracking-tight mb-4">Growth Areas</h3>
          <ul className="space-y-4">
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 mt-1.5 rounded-full bg-blue-500 shrink-0" />
              <div className="flex-1">
                <p className="text-[14px] font-semibold text-text-primary">Cross-Team Communication</p>
                <p className="text-[13px] text-text-primary mt-0.5">Opportunity to increase visibility of technical decisions with product stakeholders.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 mt-1.5 rounded-full bg-blue-500 shrink-0" />
              <div className="flex-1">
                <p className="text-[14px] font-semibold text-text-primary">Mentorship</p>
                <p className="text-[13px] text-text-primary mt-0.5">Consider leading more pairing sessions with junior developers.</p>
              </div>
            </li>
          </ul>
        </Card>
