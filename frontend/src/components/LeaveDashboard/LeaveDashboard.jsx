      ...
      >
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-gray-600">Track and manage employee leaves across the organization</p>
          </div>
          <motion.button
        ...
        <Card className="border-gray-200 bg-white overflow-x-auto">
          {employees.length === 0 ? (
            <div className="text-center py-12 text-gray-500">
              ...
              <p className="text-lg font-medium">No leave data found for this period</p>
            </div>
          ) : (
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-50">
                    ...
                    <th className="text-center py-3 px-4 text-gray-700 font-semibold">Total Leaves</th>
                    <th className="text-center py-3 px-4 text-gray-700 font-semibold">Total Days</th>
                    <th className="text-left py-3 px-4 text-gray-700 font-semibold">Sick Leave</th>
                    <th className="text-left py-3 px-4 text-gray-700 font-semibold">Casual Leave</th>
                    <th className="text-left py-3 px-4 text-gray-700 font-semibold">Vacation Leave</th>
                    <th className="text-left py-3 px-4 text-gray-700 font-semibold">PTO</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <Card className="border-gray-200 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-700"><strong>Sick Leave</strong> - Medical/Health related</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded bg-blue-100 border-2 border-blue-800"></div>
              <span className="text-gray-700"><strong>Casual Leave</strong> - Personal time off</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded bg-green-100 border-2 border-green-800"></div>
              <span className="text-gray-700"><strong>Vacation Leave</strong> - Planned vacation</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-4 h-4 rounded bg-purple-100 border-2 border-purple-800"></div>
              <span className="text-gray-700"><strong>PTO</strong> - Paid Time Off</span>
            </div>
          </div>
        </Card>
      </motion.div>
